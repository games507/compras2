...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                 ...
                 <!--   <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="../../dist/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">Municipio de San Miguelito </span> </a>
                        ...
                        <!--    <li class="user-header text-bg-primary"> <img src="../../dist/assets/img/user2-160x160.jpg" class="rounded-circle shadow" alt="User Image">
                                <p>
                                    Municipio San miguelito - Web Developer
        ...
        <aside style="background-color: #002d69; color: #FFFFFF !important;" class="app-sidebar shadow"> <!--begin::Sidebar Brand-->
            ...
            <!--    <nav class="mt-2"> 
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li style="color: #FFFFFF !important;" class="nav-item menu-open"> <a href="#" class="nav-link active"> <i style="color: #FFFFFF !important;" class="nav-icon bi bi-cart-check"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="./ver_registrosx.php" class="nav-link active"> <i style="color: #FFFFFF !important;" class="nav-icon bi bi-circle"></i>
                                        <p style="color: #FFFFFF !important;">Portal</p>
                                    </a> </li>
                                    <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        <a href="index.php" class="nav-link">
                            ...
                            <p style="color: #FFFFFF !important;">Inicio</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="formulario_compra.html" class="nav-link">
                            <i class="nav-icon fas fa-edit"></i>
                            <p style="color: #FFFFFF !important;">Registrar Compra</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ver_registrosx.php" class="nav-link">
                            <i class="nav-icon fas fa-list"></i>
                            <p style="color: #FFFFFF !important;">Lista de Compras</p>
                        </a>
                    </li>
                </ul>
            </nav>-->
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
                    ...
                    <div class="row">
                        ...
                        <!--<div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="#">Home3</a></li>
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">San Miguelito Mas Bonito</div> <!--end::To the end--> <!--begin::Copyright--> <strong>
